 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person3 p3 = new Person3("Ryan Tobin");
      ...
      Person5 p5 = new Person5("Tejas Vedantham");
      toPrint += p5.toString("tvedantham3");
 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Lydia Sink");
		  toPrint += p2.toString("lsink3");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Ryan Tobin");
		  toPrint += p3.toString("rtobin6");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Samantha Daugherty");
...
>>>>>>> 35e479c1e4b8e6966bd45f311a11f950c836bcde
